(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		? factory(exports, require('node:stream'), require('preact'))
		: typeof define === 'function' && define.amd
		? define(['exports', 'node:stream', 'preact'], factory)
		: ((global = global || self),
		  factory(
				(global.preactRenderToString = {}),
				global.node_stream,
				global.preact
		  ));
	...
	function styleObjToCss(s) {
		...
		for (let prop in s) {
			...
			if (val != null && val !== '') {
				...
				if (
					typeof val === 'number' && // Exclude custom-attributes
					!name.startsWith('--') &&
	...
	function _renderToString(
		...
		if (typeof type == 'function') {
			...
			if (type === preact.Fragment) {
				...
				if (
					isClassComponent &&
					preact.options.errorBoundaries &&
	...
	async function renderToChunks(vnode, { context, onWrite, abortSignal }) {
		context = context || {};
		/** @type {RendererState} */
